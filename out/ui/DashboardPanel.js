...
class DashboardPanel {
    ...
    _panel;
    _disposables = [];
    constructor(panel, metrics, insight, onWipe) {
        this._panel = panel;
    ...
    static createOrShow(metrics, insight, onWipe) {
        ...
        const panel = vscode.window.createWebviewPanel('silentMentorDashboard', 'Session Telemetry', column || vscode.ViewColumn.One, { enableScripts: true });
    ...
    _getHtml(metrics, insight) {
        ...
        const fileData = metrics.fileTime && Object.keys(metrics.fileTime).length > 0
